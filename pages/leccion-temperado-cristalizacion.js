...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Recupera sin mirar</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">La secuencia que debes poder reconstruir</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Antes de leer el procedimiento, escribe 45 °C → 28 °C → combinación → verificación y las temperaturas de trabajo que recuerdes para oscuro, leche y blanco. Después contrasta con la fuente y corrige únicamente lo necesario.</p></section>
