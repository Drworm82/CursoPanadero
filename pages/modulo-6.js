...
const lessons = [
  ...
  ['41', 'Croissant: empaste y vueltas', 'Sigue la secuencia documentada de fermentación, refrigeración, empaste, vueltas, formado y horneado.', '/leccion-croissant-empaste-y-vueltas', false],
...
export default function ModuleSixPage() {
  return (
    <CourseShell eyebrow="Módulo 6" title={module.title} backHref="/ruta" backLabel="Volver a la ruta">
