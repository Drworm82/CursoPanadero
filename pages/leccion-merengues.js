      ...
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-3 text-stone-700">
            <p>1. 1. ¿A qué temperatura pasa la mezcla de claras y azúcar de los honguitos a la batidora?</p>
            <p>2. 2. ¿Qué cambios debes observar durante el batido final?</p>
            <p>3. 3. ¿Qué diferencia establece la lección entre el procedimiento documentado de los honguitos y la introducción del merengue italiano?</p>
          </div>
        </section>
<section className="rounded-2xl bg-stone-900 p-6 text-white sm:p-8">
