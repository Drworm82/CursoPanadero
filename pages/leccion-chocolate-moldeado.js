...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Decide el siguiente paso</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Del temperado al molde</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Sin mirar la receta, ordena estas operaciones del ejercicio de cardamomo: temperar, preparar el saborizante, llevar la manteca a 28 °C, combinar, llenar el molde, retirar excedentes, enfriar y desmoldar. Después verifica el orden documentado.</p></section>
