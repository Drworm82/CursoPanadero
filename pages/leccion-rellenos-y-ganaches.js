...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Compara funciones</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Cobertura y relleno no son la misma parte</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Elige uno de los bombones documentados y separa de memoria cobertura, relleno y cierre. Después verifica qué preparación corresponde a cada componente y en qué momento aparece.</p></section>
