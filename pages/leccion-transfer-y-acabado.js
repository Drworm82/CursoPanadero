...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Reconstruye una decisión</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">¿Cuándo entra el acabado?</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Ordena de memoria película → trufa → película → corte → baño → transfer → enfriado → retiro. Después verifica qué pasos están documentados y cuáles corresponden a la secuencia que la fuente describe.</p></section>
