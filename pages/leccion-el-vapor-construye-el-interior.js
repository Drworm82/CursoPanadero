      ...
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-3 text-stone-700">
            <p>1. 1. ¿Qué papel atribuye la fuente al agua durante la cocción de la choux?</p>
            <p>2. 2. ¿Qué cambio observable ocurre en el interior de la pieza durante la expansión?</p>
            <p>3. 3. ¿Qué dos indicaciones de temperatura aparecen en la misma fuente y cómo las conserva la lección sin inventar una reconciliación?</p>
          </div>
        </section>
<section className="rounded-2xl bg-stone-900 p-6 text-white sm:p-8">
