...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Transfiere</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Lee la formulación, no inventes una regla</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Compara dos rellenos de esta clase y señala qué ingrediente o etapa cambia. Después explica qué permanece igual en la secuencia documentada y qué no puedes generalizar porque la fuente solo lo presenta en una fórmula concreta.</p></section>
