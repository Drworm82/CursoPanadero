...
const lesson = { number: '66', title: 'Pastelería Contemporánea IV', subtitle: 'Clase 37 · Pastelería Contemporánea IV' };

export default function LessonPage() {
  return (
    <CourseShell eyebrow="Módulo 8 · Lección 66" title={lesson.title} subtitle={lesson.subtitle} backHref="/modulo-8" backLabel="Volver al módulo">
