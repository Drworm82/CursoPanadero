      ...
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-3 text-stone-700">
            <p>1. 1. ¿Qué ocurre con la harina durante la primera cocción en la cacerola?</p>
            <p>2. 2. ¿Qué señal indica que la masa ha llegado al punto de secado descrito por la fuente?</p>
            <p>3. 3. ¿Qué operación ocurre después de esta cocción y antes del formado?</p>
          </div>
        </section>
<section className="rounded-2xl bg-stone-900 p-6 text-white sm:p-8">
