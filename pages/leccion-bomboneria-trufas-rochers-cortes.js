...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Discrimina antes de ejecutar</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">¿Qué formato exige qué operación?</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Sin consultar las recetas, asigna a bombón, trufa, rocher y chocolate de corte una operación principal: moldear, cortar, bolear o bañar/revolver según lo documentado. Después verifica cada caso y corrige tu clasificación.</p></section>
