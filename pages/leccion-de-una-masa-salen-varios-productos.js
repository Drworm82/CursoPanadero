    ...
    >
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-3 text-stone-700">
            <p>1. 1. ¿Qué cuatro aplicaciones de la pasta choux enumera la fuente?</p>
            <p>2. 2. ¿Qué puede permanecer igual cuando la pasta se convierte en productos diferentes?</p>
            <p>3. 3. ¿Qué información sobre los formados individuales no debes inventar si la fuente no la desarrolla?</p>
          </div>
        </section>
<section className="rounded-2xl bg-stone-900 p-6 text-white sm:p-8">
