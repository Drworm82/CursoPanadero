...
<section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-700">Idea central</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">La elaboración como cadena de trabajo</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Framboisier permite estudiar una producción completa: primero se construyen los componentes y después se encadenan montaje, frío, acabado y corte.</p></section>
<section className="rounded-2xl border border-dashed border-stone-300 bg-stone-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Observa y practica</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Reconstruye la producción</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Recupera bizcocho, crema pastelera, crema mousseline, montaje y frío. Observa qué etapa prepara la siguiente. Práctica: reconstruye la secuencia y marca dónde aparece el relleno de frambuesas, dónde se alisa, cuándo se congela y cuándo se termina.</p></section>

<section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-700">Idea central</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Un pastel grande se entiende como una secuencia de producción</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Framboisier permite leer una elaboración completa como cadena: bizcocho, crema pastelera, crema mousseline, relleno de frambuesas, alisado, congelación, acabado, brillo, corte y decoración. El aprendizaje está en reconocer cómo cada etapa prepara la siguiente.</p></section>
