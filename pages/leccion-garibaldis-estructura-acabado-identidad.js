    ...
    >
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-dashed border-stone-300 bg-stone-50 p-6 sm:p-8">
          ...
          <p className="mt-2 leading-7 text-stone-600">Divide la receta en antes del horno y después del horno. Observa qué operaciones cambian la pieza después de la cocción.</p>
        </section>
        ...
        <section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-3 text-stone-700">
            <p>1. ¿Qué ocurre con las claras antes de incorporarlas?</p>
            <p>2. ¿Qué temperatura y tiempo de horneado documenta la fuente?</p>
            <p>3. ¿Qué dos operaciones completan el acabado de los Garibaldis?</p>
          </div>
        </section>
