  ...
  return (
    <CourseShell eyebrow="Módulo 8" title={moduleInfo.title} backHref="/ruta" backLabel="Volver a la ruta">
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-700">Cómo estudiar este módulo</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">La autonomía cambia de una lección a otra</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Aquí no necesitas memorizar primero todas las técnicas. Cada receta recupera conocimientos anteriores justo cuando vuelven a utilizarse. Mientras trabajas, identifica el componente que estás preparando, observa qué cambia durante el proceso y comprueba cómo entra después en el montaje.</p><div className="mt-5 grid gap-3 md:grid-cols-4"><div className="rounded-xl bg-stone-50 p-4"><p className="font-semibold text-stone-900">59–61 · Modela</p><p className="mt-2 text-sm leading-6 text-stone-600">Aprende a leer capas, dependencias y encamisado en preparaciones complejas.</p></div><div className="rounded-xl bg-stone-50 p-4"><p className="font-semibold text-stone-900">62–64 · Reconstruye</p><p className="mt-2 text-sm leading-6 text-stone-600">Recupera técnicas conocidas y reconstruye montajes con menos apoyo.</p></div><div className="rounded-xl bg-stone-50 p-4"><p className="font-semibold text-stone-900">65–67 · Compara y transfiere</p><p className="mt-2 text-sm leading-6 text-stone-600">Reconoce patrones aunque cambien sabores, componentes o combinación.</p></div><div className="rounded-xl bg-stone-50 p-4"><p className="font-semibold text-stone-900">68–69 · Analiza</p><p className="mt-2 text-sm leading-6 text-stone-600">Compara fórmulas y detecta qué está documentado y qué queda abierto.</p></div></div></section>
