...
<section className="rounded-2xl border border-dashed border-stone-300 bg-stone-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Observa y practica</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Reconstruye la producción</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">Recupera biscuit, jarabes, crema pastelera, mousseline, bavaroise y chocolate temperado. Distingue preparaciones base, derivados y acabados. Práctica: ordena los componentes desde la primera preparación hasta el montaje individual y explica qué cambia si alteras esa secuencia.</p></section>
