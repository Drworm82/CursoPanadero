...
const lessons = [
  ['35', 'Entrar al pan mexicano', 'Identifica qué productos mexicanos están realmente documentados y qué aspectos de su elaboración pueden compararse.', '#'],
...
export default function ModuleFivePage() {
  return (
    <CourseShell eyebrow="Módulo 5" title={module.title} backHref="/ruta" backLabel="Volver a la ruta">
