...
<section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-sm font-medium uppercase tracking-[0.14em] text-amber-800">Transfiere</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Predice antes de leer</h2><p className="mt-3 max-w-3xl leading-7 text-stone-700">A partir de las preparaciones anteriores del módulo, predice qué componentes de Tango reconocerás y cuáles tendrás que aprender como combinación nueva. Después verifica la receta y separa claramente coincidencias de novedades.</p></section>
